...
var file_proto_definitions_proto_rawDesc = []byte{
	...
	0x6c, 0x42, 0x08, 0x5a, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_proto_definitions_proto_goTypes = []interface{}{
	...
	(*AsyncConsensus_Block)(nil), // 5: AsyncConsensus.Block
}
var file_proto_definitions_proto_depIdxs = []int32{
	...
	5, // 2: AsyncConsensus.blockHigh:type_name -> AsyncConsensus.Block
	5, // 3: AsyncConsensus.blockNew:type_name -> AsyncConsensus.Block
	5, // 4: AsyncConsensus.blockCommit:type_name -> AsyncConsensus.Block
	5, // 5: AsyncConsensus.Block.parent:type_name -> AsyncConsensus.Block
